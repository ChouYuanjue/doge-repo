...
from data.plugins.apis.api_manager import APIManager


# 定义缓存路径
DATA_PATH = Path("./data/plugins_data/doge_apis")
...
@register(
    "doge_apis",
    "runnel, Zhalslar",
    "改自Zhalslar的插件。使用网络上的一些杂乱api。不保证可使用性。",
    "v1.0.9"
)
