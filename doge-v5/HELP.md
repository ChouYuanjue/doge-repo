...
SUBCOMMANDS
  ...
  daily             3 功能  超理日报查看与订阅管理：日报是独立于日常人格/群聊上下文的严谨多页图片报告，主题全集来自官方 #今日活跃，逐主题补首楼与最近24小时楼层证据。空参数/now 立即发送当前报告；定时日报与实时 push 独立。
...
DIRECT
  /chaoli daily [now|push|on [HH:MM]|off|status|test]
    超理日报查看与订阅管理：日报是独立于日常人格/群聊上下文的严谨多页图片报告，主题全集来自官方 #今日活跃，逐主题补首楼与最近24小时楼层证据。空参数/now 立即发送当前报告；定时日报与实时 push 独立。

SUBCOMMANDS
  now              查看超理日报：立即发送当前完整多页图片日报到当前群；报告不经过日常人格或群聊上下文，使用官方 #今日活跃主题全集和逐帖公开证据，不修改定时 last_sent。
    /chaoli daily now
  push             主动触发超理日报推送：立即发送当前完整多页图片日报到当前群，报告独立于日常人格/群聊上下文；成功后若已启用定时日报则推进当天 last_sent，避免 23:45 重复发送。
    /chaoli daily push
